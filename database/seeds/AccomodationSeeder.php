...
class AccomodationSeeder extends Seeder
{
   ...
   public function run()
   {
      $accomodations = [
         ...
         [
            'title' => "BILOCALE SILENZIOSO",
            'description' => "Bilocale ristrutturato con mobilia in stile fiorentino ,camera con letto matrimoniale armadio, cassettiera, specchio tv e divano letto. La cucina ha un tavolo cn 3 sedie un grande frigo, una piastra a induzione un microonde e tutte le stoviglie.",
            'number_rooms' => 2,
            'number_bathrooms' => 1,
            'number_beds' => 2,
            'square_mts' => 50,
